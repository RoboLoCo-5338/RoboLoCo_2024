...
public final class Constants {
  ...
  // field information
  public static final double ampHeightBottom =
      Units.feetToMeters(2) + Units.inchesToMeters(2); // in meters
  ...
  public static final double speakerHeightTop =
      Units.feetToMeters(6) + Units.inchesToMeters(10 + 7 / 8);
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularSpeed =
        2 * Math.PI * 1; // set the last number back to 1 for normal speed
