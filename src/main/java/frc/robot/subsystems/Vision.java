...
public class Vision {
  ...
  private static final PhotonPoseEstimator photonEstimator =
                new PhotonPoseEstimator(Constants.kTagLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, null); //TODO: Replace with the transform of the robot to the camera
