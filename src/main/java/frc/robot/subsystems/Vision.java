...
public final class Vision {
  ...
  static Transform3d robotToCam = new Transform3d(new Translation3d(Constants.X_OFFSET_CAMERA_TO_PIVOT,
                                                                    Constants.Y_OFFSET_CAMERA_TO_PIVOT,
                                                                    Constants.Z_OFFSET_CAMERA_TO_PIVOT),
  ...
  public static double getTargetAngle(boolean radians, double target) {
    if (!hasResults()) {
      return Double.POSITIVE_INFINITY;
    }

    if (radians) {
      return Units.degreesToRadians(target);
    }
  ...
  public static double getTargetPitch(boolean radians) { //The boolean is if you want or don't want radians
    return getTargetAngle(radians, getBestTarget().getPitch());
  }

  public static double getTargetYaw(boolean radians) { //The boolean is if you want or don't want radians
    return getTargetAngle(radians, getBestTarget().getYaw());
  }
