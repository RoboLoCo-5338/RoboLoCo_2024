...
public class AutoAimSubsystem {
    ...
    private static final double SPEAKER_TAG_HEIGHT = Constants.aprilTagUniqueHeights[1]
    ...
    public static double getOptimalAngleRadians(double distanceToTag, double angleToTag, double angleCurrent) {
        double resultDegree;
        double numerator = DISTANCE_CAMERA_TO_TAG_Y - (Constants.ARM_LENGTH * Math.sin(angleCurrent))
    ...
    public static double getOptimalAngleDegrees(double distanceToTag, double angleToTag, double angleCurrent) {
        double resultDegree;
        double numerator = DISTANCE_CAMERA_TO_TAG_Y - (Constants.ARM_LENGTH * Math.sin(Math.toRadians(angleCurrent)))
                + DISTANCE_TAG_TO_SPEAKER;
