...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public IntakeSubsystem() {
    ...
    indexerMotor =
        new CANSparkMax(Constants.DriveConstants.kIntakeIndexCanId, MotorType.kBrushless);
  ...
  public boolean isNote() {
    try {
      if (getLaserCanMeasurement() != null
        ...
        return getLaserCanMeasurement().distance_mm / 1000.0
            < Constants.AutoConstants.normalLaserCAN;
      }
    } catch (Exception E) {
      return false;
    }
