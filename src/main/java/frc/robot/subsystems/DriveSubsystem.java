...
public class DriveSubsystem extends SubsystemBase {
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig(
            ...
            Units.Meters.convertFrom(
                Math.sqrt(Math.pow(22.5 / 2.0, 2) + Math.pow(22.5 / 2.0, 2)), Units.Inches),
  ...
  public void drive(
    ...
    double ySpeedDelivered =
        ySpeedCommanded
            ...
            * (RobotContainer.slowMode ? 0.6 : 1.0);
    double rotDelivered =
        m_currentRotation * DriveConstants.kMaxAngularSpeed * (RobotContainer.slowMode ? 0.6 : 1.0);
    ...
    if (autoMode) {
      swerveModuleStates[0].speedMetersPerSecond =
          swerveModuleStates[0].speedMetersPerSecond * 0.72;
    }
  ...
  public void straightLogMotor(SysIdRoutineLog log, String motorName, MAXSwerveModule module) {
    log.motor(motorName)
        .voltage(
            m_appliedVoltage.mut_replace(module.m_drivingSparkMax.getBusVoltage(), Units.Volts))
        .linearPosition(
  ...
  public void turnLogMotor(SysIdRoutineLog log, String motorName, MAXSwerveModule module) {
    log.motor(motorName)
        .voltage(
            m_appliedVoltage.mut_replace(module.m_turningSparkMax.getBusVoltage(), Units.Volts))
        .linearPosition(
            m_distance.mut_replace(
