...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig(
            new PIDConstants(0.20, 0.0, 0.0),
            new PIDConstants(0.65, 0.0, 0.0),
            // Constants.AutoConstants.kMaxSpeedMetersPerSecond,
            4.8,
            /* 0.394, */
            Units.Meters.convertFrom(Math.sqrt(Math.pow(22.5 / 2.0, 2) + Math.pow(22.5 / 2.0, 2)), Units.Inches), // Changed
                                                                                                                  // 6/1/24,
                                                                                                                  // approx.
                                                                                                                  // value
                                                                                                                  // is
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit,
    ...
    if (rot == 0) {
      ...
      // SmartDashboard.putNumber("Angle: front left module", m_frontLeft.getPosition().angle.getRadians());
      // SmartDashboard.putNumber("Angle: front right module", m_frontRight.getPosition().angle.getRadians());
      // SmartDashboard.putNumber("Angle: rear left module", m_rearLeft.getPosition().angle.getRadians());
      // SmartDashboard.putNumber("Angle: rear right module", m_rearRight.getPosition().angle.getRadians());
    ...
    SwerveModuleState[] swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered,
                Rotation2d
                    .fromDegrees(m_gyro.getYaw().getValueAsDouble() * (DriveConstants.kGyroReversed ? -1.0 : 1.0)))
  ...
  public SysIdRoutine m_driveSysIdRoutine = new SysIdRoutine(
          ...
          log -> {
            ...
            log.motor("drive-front-left")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_frontLeft.m_drivingEncoder.getPosition()
                        * m_frontLeft.m_drivingEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
            ...
            log.motor("drive-front-right")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_frontRight.m_drivingEncoder.getPosition()
                        * m_frontRight.m_drivingEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
            ...
            log.motor("drive-rear-left")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_rearLeft.m_drivingEncoder.getPosition()
                        * m_rearLeft.m_drivingEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
            ...
            log.motor("drive-rear-right")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_rearRight.m_drivingEncoder.getPosition()
                        * m_rearRight.m_drivingEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
  ...
  public SysIdRoutine m_steerSysIdRoutine = new SysIdRoutine(
      new SysIdRoutine.Config(),
      new SysIdRoutine.Mechanism(
          ...
          log -> {
            log.motor("turn-front-left")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_frontLeft.m_turningEncoder.getPosition()
                        * m_frontLeft.m_turningEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_frontLeft.m_turningEncoder.getVelocity()
                            * m_frontLeft.m_turningEncoder.getVelocityConversionFactor(),
                        Units.MetersPerSecond));
            ...
            log.motor("turn-front-right")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_frontRight.m_turningEncoder.getPosition()
                        * m_frontRight.m_turningEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_frontRight.m_turningEncoder.getVelocity()
                            * m_frontRight.m_turningEncoder.getVelocityConversionFactor(),
                        Units.MetersPerSecond));
            ...
            log.motor("drive-rear-left")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_rearLeft.m_turningEncoder.getPosition()
                        * m_rearLeft.m_turningEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_rearLeft.m_turningEncoder.getVelocity()
                            * m_rearLeft.m_turningEncoder.getVelocityConversionFactor(),
                        Units.MetersPerSecond));
            ...
            log.motor("drive-rear-right")
                ...
                .linearPosition(m_distance.mut_replace(
                    m_rearRight.m_turningEncoder.getPosition()
                        * m_rearRight.m_turningEncoder.getPositionConversionFactor(),
                    Units.Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_rearRight.m_turningEncoder.getVelocity()
                            * m_rearRight.m_turningEncoder.getVelocityConversionFactor(),
                        Units.MetersPerSecond));
          },
          this));
