...
public class IntakeCommands {
	...
	// //() ->
	// Math.abs(RobotContainer.m_Arm.armHeights[preset]-RobotContainer.m_Effector.getEffectorPosition())
	// <= 0.1,
	...
	public static Command runIntakeForwardTimed(long time) {
		return new FunctionalCommand(() -> {
			...
			startTime = System.currentTimeMillis();
				...
				() -> System.currentTimeMillis() - time > startTime, RobotContainer.m_Intake);
	}
