...
public final class IntakeCommands {
  ...
  public static Command moveIntakeIn() {
    return new InstantCommand(RobotContainer.m_Intake::inIntakeIndexer, RobotContainer.m_Intake);
  }

  public static Command moveIndexerInFast() {
    return new InstantCommand(RobotContainer.m_Intake::indexerInFast, RobotContainer.m_Intake);
  }

  // Command bindings for arm and elevator methods.
  public static Command moveIntakeOut() {
    return new InstantCommand(RobotContainer.m_Intake::outIntakeIndexer, RobotContainer.m_Intake);
  }

  public static Command stopIntake() {
    return new InstantCommand(RobotContainer.m_Intake::stopIntakeIndexer, RobotContainer.m_Intake);
  }

  public static Command runIntakeForwardTimed(long time) {
    return new TimedCommand(time, RobotContainer.m_Intake::inIntakeIndexer, RobotContainer.m_Intake::stopIntakeIndexer, RobotContainer.m_Intake);
  }

  public static Command runIntakeOnlyTimed(long time) {
    return new TimedCommand(time, RobotContainer.m_Intake::intakeIn, RobotContainer.m_Intake::stopIntake, RobotContainer.m_Intake);
  }

  public static Command runIndexerOnlyTimed(long time) {
    return new TimedCommand(time, RobotContainer.m_Intake::indexerInFast, RobotContainer.m_Intake::stopIndexer, RobotContainer.m_Intake);
  }
