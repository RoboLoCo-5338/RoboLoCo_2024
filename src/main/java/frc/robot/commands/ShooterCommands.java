...
public class ShooterCommands {
	...
	public static Command runShooterForwardTimed(long time) {
		...
		}, () -> RobotContainer.m_shooter.shooterForward(), interrupted -> RobotContainer.m_shooter.shooterStop(),
				() -> System.currentTimeMillis() - time > startTime, RobotContainer.m_shooter);
	}
	...
	public static Command runShooterBackwardTimed(long time) {
		return new FunctionalCommand(() -> {
			RobotContainer.m_shooter.shooterStop();
			startTime = System.currentTimeMillis();
		}, () -> RobotContainer.m_shooter.shooterReverse(), interrupted -> RobotContainer.m_shooter.shooterStop(),
				() -> System.currentTimeMillis() - time > startTime, RobotContainer.m_shooter);
	}
}
