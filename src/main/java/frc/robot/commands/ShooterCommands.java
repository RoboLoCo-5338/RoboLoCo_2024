  ...
  private static long startTime;
    ...
    public static Command runShooterForwardTimed(long time){
      ...
      return new FunctionalCommand(() -> {
        RobotContainer.m_shooter.shooterStop();
        startTime = System.currentTimeMillis();
      },() -> RobotContainer.m_shooter.shooterReverse(),interrupted -> RobotContainer.m_shooter.shooterStop(), () -> System.currentTimeMillis()-time>startTime, RobotContainer.m_shooter);
    }
